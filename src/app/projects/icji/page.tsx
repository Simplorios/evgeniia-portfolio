...
const Section: React.FC<SectionProps> = ({className, ...props}) => {
    return <section className={clsx('container mx-auto py-20 border-b-4 border-primary', className)} {...props} />
}
    ...
    return <>
        ...
        <Section className="mt-5 grid grid-flow-col gap-x-14 gap-y-11.5 grid-cols-3 grid-rows-3">
            ...
            <div className="grid grid-cols-2 gap-x-14 items-center">
                <Image src="/icji/result/icji-in-1.png" alt="Inspiration 1" width={187.67} height={187.67}/>
                <Image src="/icji/arrow.svg" alt="Arrow" width={56.85} height={24.47}/>
            </div>
            <div className="grid grid-cols-2 gap-x-14 items-center">
                <Image src="/icji/result/icji-in-2.png" alt="Inspiration 2" width={187.67} height={187.67}/>
                <Image src="/icji/arrow.svg" alt="Arrow" width={56.85} height={24.47}/>
            </div>
            <div className="grid grid-cols-2 gap-x-14 items-center">
                <Image src="/icji/result/icji-in-3.png" alt="Inspiration 3" width={187.67} height={187.67}/>
                <Image src="/icji/arrow.svg" alt="Arrow" width={56.85} height={24.47}/>
            </div>
            <Image className="row-span-3" src="/icji/result/icji-in-result.png" alt="Inspiration result" width={369} height={699}/>
        </Section>
        ...
        <Section>
            ...
            <div className="mt-20 grid grid-cols-2 gap-x-12">
                <p className="text-[1.75rem]/[1]">
                    → The composition is built on a grid enclosed in a circle,
                    which further develops into
                    the famous Chinese lantern.<br/>
                    <br/>
                    Inside the circle is a geometric
                    composition of Chinese
                    symbols such as the tea
                    house and bamboo
                </p>
                <div className="grid grid-flow-col items-center gap-x-6">
                    <Image src="/icji/transform/icji-transform-1.png" alt="Transform 1" width={157} height={157}/>
                    <Image src="/icji/arrow.svg" alt="Arrow" width={49.5} height={21.3}/>

                    <Image src="/icji/transform/icji-transform-2.png" alt="Transform 2" width={157} height={157}/>
                    <Image src="/icji/arrow.svg" alt="Arrow" width={49.5} height={21.3}/>

                    <Image src="/icji/result/icji-in-result.png" alt="Transform result" width={157} height={298}/>
                </div>
            </div>
        </Section>
        <Section>
        ...
        <Section className="grid grid-cols-2 grid-rows-3">
            ...
            <Image className="row-span-3" src="/icji/typefaces/font.png" alt="Font" width={780} height={498}/>
        ...
        <Section className="grid grid-cols-2 justify-between gap-y-22">
            ...
            <Image src="/icji/products/business-card.png" alt="Business card"  width={693} height={462}/>

            <h2 className="text-5xl/[1]">Envelope</h2>
            <Image src="/icji/products/envelope.png" alt="Envelope" width={693} height={462}/>

            <h2 className="text-5xl/[1]">Tote bags</h2>
            <Image src="/icji/products/bag.png" alt="Tote bags" width={693} height={616}/>

            <h2 className="text-5xl/[1]">Box</h2>
            <Image src="/icji/products/box.png" alt="Box" width={693} height={597}/>
        </Section>
